# 🚀 SEO Оптимизация проекта CodeHero
...
### `SEO.tsx`
Управляет всеми мета-тегами, title, description, Open Graph и Twitter Card.

### `StructuredData.tsx`
Добавляет Schema.org разметку для лучшего понимания контента поисковыми системами.

### `Hreflang.tsx`
Управляет мультиязычными hreflang тегами для правильной индексации.

### `SemanticHTML.tsx`
Семантические HTML компоненты для лучшей структуры страницы.

### `ImageOptimization.tsx`
Оптимизация изображений с SEO атрибутами и lazy loading.

### `InternalLink.tsx`
SEO-оптимизированные внутренние ссылки.

### `PerformanceOptimization.tsx`
Компоненты для оптимизации производительности и Core Web Vitals.
...
### 1. Обновить домен
В файлах замените `https://codehero.com` на ваш реальный домен:
- `index.html`
- `sitemap.xml`
- `robots.txt`
